...
<body>
	...
	<form action="register" method="post">
		...
		<input type="submit" name="Sign Up" value="REGISTER"> | <input type=reset name="reset" value="RESET"><br>
		</pre>
	</form>
</body>
</html-->
...
<form action="register" method="post">
  ...
  <div class="container signin">
    <p>Already have an account? <a href="index.html">Sign in into portal</a></p>
  </div>
</form>
